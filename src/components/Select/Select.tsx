...
export const Select = <TOption extends Option>({
  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <Listbox.Button className="flex items-center py-2.5 px-4 w-full text-lg font-bold dark:placeholder-gray-400 text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 focus:border-blue-500 dark:border-gray-600 dark:focus:border-blue-500 focus:ring-blue-500 dark:focus:ring-blue-500">
